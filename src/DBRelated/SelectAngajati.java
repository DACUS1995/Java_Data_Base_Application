...
public class SelectAngajati {
    ...
    public static ObservableList<Angajati> getDataFromDB() {
        ...
        try {
            ...
            while (rs.next()) {
                data.add(new Angajati(rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11)));
            }
