...
public class Cerere_Simpla_5 {
    ...
    @FXML
    private TableColumn<String[], String> numarAngajati;
    ...
    private void initialize() {
        ...
        numarAngajati.setCellValueFactory((p) -> {
            String[] x = p.getValue();
        ...
        try {
            call = con.prepareCall("{call Cerere_Simpla_5()}");
